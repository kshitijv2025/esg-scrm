...
DEFAULT_THRESHOLDS: dict[str, dict[str, Any]] = {
    "energy_kwh": {
        "max": 3500000,
        "severity": "WARNING",
        "text": "Energy consumption exceeds threshold",
    },
    "water_m3": {"max": 20000, "severity": "WARNING", "text": "Water withdrawal exceeds threshold"},
    "diesel_consumed": {
        "max": 100,
        "severity": "CRITICAL",
        "text": "Diesel usage exceeds threshold",
    },
    "waste_tonnes": {
        "max": 50,
        "severity": "WARNING",
        "text": "Waste generation exceeds threshold",
    },
    "scope3_category6": {
        "max": 10000,
        "severity": "INFO",
        "text": "Scope 3 Cat 6 emissions elevated",
    },
}
    ...
    try:
        ...
        for row in latest:
            ...
            if value > threshold["max"]:
                ...
                flag_text = (
                    f"{threshold['text']}: {value} {row['unit']} (threshold: {threshold['max']})"
                )
