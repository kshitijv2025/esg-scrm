...
class SAPBusinessOneAdapter(ERPConnector):
    ...
    def __init__(
        ...
        """
        self._server_url = server_url if server_url is not None else os.environ.get("SAP_B1_SERVER_URL", "")
        self._api_key = api_key if api_key is not None else os.environ.get("SAP_B1_API_KEY", "")
