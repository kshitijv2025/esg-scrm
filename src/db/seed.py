...
def _seed_metrics_and_evidence(conn: sqlite3.Connection) -> None:
    ...
    metrics_data = [
        {"cluster": "energy_kwh", "value": 2847320, "unit": "kWh", "confidence": "HIGH",
         "source": "SAP Business One — Utility Invoices", "period": "January 2025",
         "recorded_at": "2025-01-31T23:59:00Z"},
        {"cluster": "emissions_tco2", "value": 892.4, "unit": "tCO2e", "confidence": "HIGH",
         "source": "Calculated — energy × grid factor", "period": "January 2025",
         "recorded_at": "2025-01-31T23:59:00Z"},
        {"cluster": "water_m3", "value": 18430, "unit": "m³", "confidence": "HIGH",
         "source": "SAP Business One — Municipal Water Bills", "period": "January 2025",
         "recorded_at": "2025-01-31T23:59:00Z"},
        {"cluster": "scope3_category1", "value": 4281.7, "unit": "tCO2e", "confidence": "MEDIUM",
         "source": "Supplier questionnaires + spend-based fallback", "period": "Q4 2024",
         "recorded_at": "2024-12-31T23:59:00Z"},
        {"cluster": "diesel_consumed", "value": 49.3, "unit": "tCO2e", "confidence": "MEDIUM",
         "source": "Manual entry — diesel generator consumption log", "period": "Q4 2024",
         "recorded_at": "2024-12-31T23:59:00Z"},
        {"cluster": "scope3_category6", "value": 37.0, "unit": "tCO2e", "confidence": "LOW",
         "source": "Manual calculation — travel expense claims × GHG emission factors", "period": "Q4 2024",
         "recorded_at": "2024-12-31T23:59:00Z"},
    ]
    ...
    for trend in trends:
        for timestamp, value in trend["months"][:-1]:  # exclude last (duplicated in latest)
            all_records.append({
                ...
                "value": value,
                "timestamp": timestamp,
                "unit": "kWh" if trend["cluster"] == "energy_kwh" else "tCO2e" if trend["cluster"] == "emissions_tco2" else "m³",
                "confidence": "HIGH",
...
def _seed_risk_flags(conn: sqlite3.Connection) -> None:
    flags = [
        {"id": "flag_001", "flag_text": "Water consumption 18% above regulatory threshold for Q4 2024",
         ...
         "created_at": "2024-10-15T09:00:00Z", "acknowledged": 0},
        {"id": "flag_002", "flag_text": "Supplier financial health score declined below 60 — risk of supply disruption",
         "cluster": "G5", "severity": "CRITICAL", "days_overdue": 12, "priority_score": 3.96,
         "created_at": "2024-12-01T14:30:00Z", "acknowledged": 0},
        {"id": "flag_003", "flag_text": "Scope 3 Category 1 coverage at 64% — below 70% target for H&M reporting",
         "cluster": "G4", "severity": "INFO", "days_overdue": 0, "priority_score": 0.0,
         "created_at": "2025-01-10T10:00:00Z", "acknowledged": 0},
        {"id": "flag_004", "flag_text": "Diesel generator log — evidence chain broken, data integrity concern",
         "cluster": "G1", "severity": "CRITICAL", "days_overdue": 3, "priority_score": 0.9,
         "created_at": "2025-01-27T08:00:00Z", "acknowledged": 1,
         "acknowledged_at": "2025-01-28T11:00:00Z", "acknowledged_by": "ops@textilebd.com"},
        {"id": "flag_005", "flag_text": "Gender pay gap metric missing for Tier 2 suppliers — compliance gap",
         "cluster": "G3", "severity": "WARNING", "days_overdue": 30, "priority_score": 2.0,
...
def _seed_supplier_scope3(conn: sqlite3.Connection) -> None:
    records = [
        {"supplier_id": "sup_001", "category": "Purchased Goods", "annual_spend_usd": 2400000,
         ...
         "emission_factor": "GHG Protocol 2022 — cotton, $0.94/kg CO2", "confidence": "MEDIUM",
         "data_source": "Questionnaire Q1 2025 — responded Jan 18"},
        {"supplier_id": "sup_002", "category": "Finished fabrics", "annual_spend_usd": 3200000,
         "scope3_tco2e": 580.8, "calculation_method": "spend_based",
         "emission_factor": "GHG Protocol 2022 — textiles, $0.94/kg CO2", "confidence": "MEDIUM",
         "data_source": "Questionnaire Q1 2025 — responded Jan 20"},
        {"supplier_id": "sup_003", "category": "Dyeing & finishing", "annual_spend_usd": 8400000,
         "scope3_tco2e": 1848.0, "calculation_method": "spend_based",
         "emission_factor": "GHG Protocol 2022 — textiles, $0.94/kg CO2", "confidence": "LOW",
         "data_source": "Spend-based estimate — supplier not yet responded"},
        {"supplier_id": "sup_004", "category": "Thread manufacturing", "annual_spend_usd": 1800000,
         "scope3_tco2e": 369.0, "calculation_method": "spend_based",
         "emission_factor": "GHG Protocol 2022 — industry average", "confidence": "LOW",
         "data_source": "Spend-based estimate — supplier not yet responded"},
        {"supplier_id": "sup_006", "category": "Synthetic fibers", "annual_spend_usd": 4200000,
         "scope3_tco2e": 1060.9, "calculation_method": "spend_based",
         "emission_factor": "GHG Protocol 2022 — synthetics, $0.94/kg CO2", "confidence": "MEDIUM",
         "data_source": "Questionnaire Q1 2025 — responded Jan 22"},
        {"supplier_id": "sup_007", "category": "Trims & accessories", "annual_spend_usd": 620000,
         "scope3_tco2e": 10.2, "calculation_method": "spend_based",
         "emission_factor": "GHG Protocol 2022 — industry average", "confidence": "LOW",
