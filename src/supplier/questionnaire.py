...
TIER1_QUESTIONS = [
    ...
    Question("t1e_02", 1, "Energy", "What percentage of your energy comes from renewable sources?", "%"),
    ...
    Question("t1s_01", 1, "Safety", "How many lost-time injuries occurred in the last 12 months?", "count"),
...
TIER2_QUESTIONS = [
    Question("t2l_01", 2, "Labour", "What is the average hourly wage paid to workers (in local currency)?", "LCU"),
    Question("t2l_02", 2, "Labour", "What is the minimum wage as a percentage of living wage?", "%"),
    Question("t2l_03", 2, "Labour", "How many workers are covered by collective bargaining agreements?", "count"),
    Question("t2l_04", 2, "Labour", "What is the average weekly working hours for production staff?", "hours"),
    Question("t2l_05", 2, "Labour", "Do you have a child labour policy prohibiting workers under 16?", None),
    Question("t2l_06", 2, "Labour", "What is the turnover rate for the past 12 months?", "%"),
    Question("t2l_07", 2, "Labour", "What is the gender pay gap (female vs male average wage)?", "%"),
]

TIER3_QUESTIONS = [
    Question("t3f_01", 3, "Fibre/Sourcing", "What percentage of cotton is certified organic or recycled?", "%"),
    Question("t3f_02", 3, "Fibre/Sourcing", "Do you have a responsible sourcing policy for raw materials?", None),
    Question("t3f_03", 3, "Fibre/Sourcing", "What percentage of materials are sourced from certified sustainable sources?", "%"),
    Question("t3f_04", 3, "Fibre/Sourcing", "Do you have GOTS, OEKO-TEX, or GRS certification?", None),
    Question("t3f_05", 3, "Fibre/Sourcing", "What is the traceability coverage of your supply chain (Tier 1 only)?", "%"),
    Question("t3f_06", 3, "Fibre/Sourcing", "What percentage of packaging materials are recyclable or compostable?", "%"),
]

TIER4_QUESTIONS = [
    Question("t4g_01", 4, "Governance", "What percentage of your board of directors is independent?", "%"),
    Question("t4g_02", 4, "Governance", "What percentage of board members are women?", "%"),
    Question("t4g_03", 4, "Governance", "Has your company undergone an independent financial audit in the past 12 months?", None),
    Question("t4g_04", 4, "Governance", "Do you have an anti-corruption policy covering all employees?", None),
    Question("t4g_05", 4, "Governance", "Have any ethics violations been reported in the past 24 months?", None),
    Question("t4g_06", 4, "Governance", "What is your data privacy compliance posture (GDPR or local equivalent)?", None),
    Question("t4g_07", 4, "Governance", "Do you maintain a grievance mechanism accessible to all workers?", None),
]

ALL_QUESTIONS = TIER1_QUESTIONS + TIER2_QUESTIONS + TIER3_QUESTIONS + TIER4_QUESTIONS
TIER_NAMES = {1: "Essential / EHS", 2: "Labour Standards", 3: "Fibre & Sourcing", 4: "Financial & Governance"}
