...
describe("TrustBadges", () => {
  ...
  it("renders multiple active badges", async () => {
    ...
    render(<TrustBadges badges={{ csrd_compliant: true, audit_ready: true }} />);
...
describe("OperationsTab", () => {
  ...
  it("renders metric cards when metrics data is available", async () => {
    ...
    const mockMetrics = {
      metrics: {
        energy_kwh: { value: 1000, unit: "kWh", confidence: "HIGH", trend: "+5%", chain_valid: true },
        emissions_tco2: { value: 50, unit: "tCO2e", confidence: "MEDIUM", trend: "-2%", chain_valid: true },
        water_m3: { value: 200, unit: "m3", confidence: "HIGH", trend: "+1%", chain_valid: true },
        scope3_category1: { value: 300, unit: "tCO2e", confidence: "LOW", trend: "+3%", chain_valid: true },
        diesel_consumed: { value: 75, unit: "litres", confidence: "MEDIUM", trend: "0%", chain_valid: true },
        scope3_category6: { value: 25, unit: "tCO2e", confidence: "HIGH", trend: "-1%", chain_valid: true },
      },
    };
    ...
    const metricLabels = screen.getAllByText(/Electricity \(Scope 2\)|Total Emissions \(Scope 1\+2\)|Water Withdrawal|Purchased Goods \(Scope 3\)|Diesel Combustion \(Scope 1\)|Business Travel \(Scope 3\)/);
